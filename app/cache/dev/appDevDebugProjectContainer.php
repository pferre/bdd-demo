...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'demo', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2f553a5de209971683549fcb675706224ce6391559f567b82b399e13ba28671b');
    ...
    /**
     * Gets the 'totalise' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Cart\Totalise A AppBundle\Cart\Totalise instance.
     */
    protected function getTotaliseService()
    {
        return $this->services['totalise'] = new \AppBundle\Cart\Totalise();
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ed5a1e272b8d9fe12c3cf633c4e681a89ef939e0');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('558916b00ae43')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'database_path' => ($this->targetDirs[2].'/../data/demo.sqlite'),
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'ed5a1e272b8d9fe12c3cf633c4e681a89ef939e0',
            'locale' => 'en',
            ...
            'kernel.secret' => 'ed5a1e272b8d9fe12c3cf633c4e681a89ef939e0',
